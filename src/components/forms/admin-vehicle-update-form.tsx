...
const vehicleFormSchema = z.object({
  ...
  owner_nok_name: z.optional(z.string()),
  owner_nok_phone: z.optional(z.string()),
  owner_nok_relationship: z.optional(z.string()),
  asin_number: z.optional(z.string().nullable()),
  t_code: z.string(),
...
export function AdminVehicleUpdateForm({ vehicle }: { vehicle: IVehicle }) {
  const defaultValues: Partial<VehicleFormValues> = {
    id: vehicle.id,
    plate_number: vehicle.plate_number,
    asin_number: vehicle.asin_number,
    t_code: vehicle.t_code?.trim() !== "" ? vehicle.t_code : undefined,
    color: vehicle.color ?? "OFFICIAL",
    ...
    try {
      const updateVehicleResponse = await fetch("/api/create-vehicle", {
        ...
        body: JSON.stringify({
          ...
          asin_number:
            data.asin_number?.trim() !== "" ? data.asin_number : null,
          t_code: data.t_code?.trim() !== "" ? data.t_code : null,
          color: data.color,
          image: data.image,
          status: data.status,
          type: data.type,
      ...
      if (!result.success) {
        ...
        setIsLoading(false);
        toast.error(
          result.error.message || result.message || "Vehicle NOT Updated"
        );
        return null;
      }
    } catch (error) {
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="pl-4 text-title1Bold">T-Code</FormLabel>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="pl-4 text-title1Bold">Color</FormLabel>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="pl-4 text-title1Bold">Image</FormLabel>

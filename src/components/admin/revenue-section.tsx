        ...
        <Grid>
          {[
            ...
            },
            {
              ...
              desc: "Year till date",
              link: "/history/yearly?revenue=CVOF",
              revenueType: "CVOF",
            },
            {
              type: "MONTH",
              ...
              link: "/history/monthly?revenue=CVOF",
              revenueType: "CVOF",
            },
            {
              type: "WEEK",
              ...
              desc: "Week till date",
              link: "/history/weekly?revenue=CVOF",
              revenueType: "CVOF",
            },
            {
              type: "DAY",
              ...
              desc: "Day till date",
              link: "/history/daily?revenue=CVOF",
              revenueType: "CVOF",
            },
          ].map((p, i) => (
        ...
        <Grid>
          {[
            ...
            },
            {
              ...
              title: "Year Till Date Revenue",
              desc: "Year till date",
              link: "/history/yearly?revenue=ISCE",
              revenueType: "ISCE",
            },
            {
              type: "MONTH",
              title: "Month Till Date Revenue",
              desc: "Month till date",
              link: "/history/monthly?revenue=ISCE",
              revenueType: "ISCE",
            },
            {
              type: "WEEK",
              title: "Week Till Date Revenue",
              desc: "Week till date",
              link: "/history/weekly?revenue=ISCE",
              revenueType: "ISCE",
            },
            {
              type: "DAY",
              title: "Day Till Date Revenue",
              desc: "Day till date",
              link: "/history/daily?revenue=ISCE",
              revenueType: "ISCE",
            },
          ].map((p, i) => (
            <Suspense key={i} fallback={<RevenueAmountCardSkeleton />}>
          ...
          {[
            {
              ...
              title: "All Time Revenue",
              desc: "All time",
              link: "/history/all?revenue=FAREFLEX",
            ...
            },
            {
              ...
              title: "Year Till Date Revenue",
              desc: "Year till date",
              link: "/history/yearly?revenue=FAREFLEX",
              revenueType: "FAREFLEX",
            },
            {
              type: "MONTH",
              title: "Month Till Date Revenue",
              desc: "Month till date",
              link: "/history/monthly?revenue=FAREFLEX",
              revenueType: "FAREFLEX",
            },
            {
              type: "WEEK",
              title: "Week Till Date Revenue",
              desc: "Week till date",
              link: "/history/weekly?revenue=FAREFLEX",
              revenueType: "FAREFLEX",
            },
            {
              type: "DAY",
              title: "Day Till Date Revenue",
              desc: "Day till date",
              link: "/history/daily?revenue=FAREFLEX",
              revenueType: "FAREFLEX",
            },
          ].map((p, i) => (
            <Suspense key={i} fallback={<RevenueAmountCardSkeleton />}>
